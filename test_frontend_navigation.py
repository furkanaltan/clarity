...
""")
    ...
    def test_one_day_renderer_is_activity_view_without_touching_long_ranges(self):
        ...
        self.assertIn('#tab-home .chart-wrap.activity-view .ranges{margin-top:63px}', self.frontend)
        ...
        self.assertIn('y="17" width="84" height="91"', self.frontend)
        self.assertIn('baseline=108, barGap=3, barBottom=baseline-barGap, labelY=126, amountY=145', self.frontend)
        self.assertIn('chartActivityBarHeight(event.amount,maxAmount,76,16)', self.frontend)
