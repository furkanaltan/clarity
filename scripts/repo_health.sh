...
if printf '%s\n' "$untracked" | grep -Ev '^$|^(CLAUDE\.md|docs/PROJECT_RULES\.md|scripts/repo_health\.sh|scripts/build_frontend_release\.py|test_frontend_build\.py|test_chart_engine_v2\.py|test_score_v2\.py)$' | grep -q .; then
